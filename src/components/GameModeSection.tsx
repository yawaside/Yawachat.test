          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10">
            ...
            <div className="absolute right-4 top-4 w-[240px] rounded-xl border border-white/15 bg-black/55 p-3 backdrop-blur-sm">
              ...
              <div className="space-y-1.5">
                {[
                  { a: "neon_wolf", t: "ЛЕЕЕЕТС ГОООУ", c: "#a78bfa" },
                  { a: "vanya_fps", t: "модератор молодец", c: "#4ade80" },
                  { a: "luna228", t: "пошёл за чаем", c: "#f472b6" },
                ].map((m, i) => (
                  <div key={i} className="flex items-start gap-1.5">
                    <span className="h-1.5 w-1.5 shrink-0 rounded-full" style={{ background: m.c, marginTop: 5 }} />
