...
/* ---------- имя приложения: YawaChat + Hub в цветном блоке ---------- */
export function AppName({
  ...
  return (
    <span className={`inline-flex items-center gap-[0.35em] ${className}`}>
      ...
      <span
        className="rounded-[0.45em] bg-gradient-to-br from-viol to-cy px-[0.45em] py-[0.12em] font-display font-bold text-white shadow-[0_0_18px_rgba(139,92,246,0.5)]"
        style={{ fontSize: size * 0.8, lineHeight: 1.35 }}
      >
        Hub
      </span>
    </span>
