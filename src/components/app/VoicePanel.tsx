      ...
      <Panel>
        ...
        <div className="mt-4 space-y-3">
          ...
          <div>
            ...
            <p className="mt-1.5 text-[10.5px] leading-snug" style={{ color: "var(--dw-dim)" }}>Silero SAPI5 и другие установленные голоса Windows остаются доступны как обычные SAPI5-голоса.</p>
          </div>
        </div>
      </Panel>
