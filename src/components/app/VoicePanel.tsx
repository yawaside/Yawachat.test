...
export default function VoicePanel({
  ...
  const defaultSileroSpeakers = ["aidar", "baya", "kseniya", "xenia", "eugene"];
  // После распаковки голоса уже можно выбрать; загрузка модели выполняется
  // лениво при первом preview/сообщении, поэтому не ждём ready для списка.
  const sileroSpeakers = sileroStatus?.installed
    ? (sileroStatus.speakers.length ? sileroStatus.speakers : defaultSileroSpeakers)
    : [];
        ...
        <div className="mt-4 space-y-3">
          ...
          <div>
            ...
            <VoiceList
              ...
              sileroInstalled={!!sileroStatus?.installed}
          ...
          >
            <div className="space-y-2.5">
              ...
              {sileroStatus?.lastError && (
                <div
                  className="rounded-xl border px-3 py-2 text-[10.5px] leading-snug"
