...
const DEMO = [
  { author: "neon_wolf", color: "#a78bfa", text: "ЛЕЕЕЕТС ГОООУ" },
  { author: "mila_lav", color: "#f472b6", text: "привет из чата, как настроение?" },
  { author: "КиберДед", color: "#4ade80", text: "респект за упорство" },
];
              ...
              <div className="space-y-2.5">
                {DEMO.map((m, i) => (
                  <div key={i} className="flex items-start gap-2">
                    <span className="h-2 w-2 shrink-0 rounded-full" style={{ background: m.color, marginTop: 6 }} />
