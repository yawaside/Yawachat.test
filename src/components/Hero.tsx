        ...
        >
          <div className="relative rounded-[26px] border border-white/10 bg-panel/80 p-4 shadow-[0_40px_120px_rgba(0,0,0,0.6)] backdrop-blur-xl">
            ...
            <div className="space-y-2.5">
              {[
                { p: "#a970ff", a: "neon_wolf", t: "ЛЕЕЕЕТС ГОООУ", delay: 0 },
                { p: "#53fc18", a: "cyber_arena", t: "кик грузит быстрее всех, факт", delay: 0.12 },
                { p: "#ff4e45", a: "LofiRadio", t: "какой трек сейчас играет?", delay: 0.24 },
                { p: "#ff3b5c", a: "@yawa.live", t: "приветики из тиктока", delay: 0.36 },
                { p: "#4c8dff", a: "vklive.cyber", t: "смотрю с вк и с кика одновременно", delay: 0.48 },
              ].map((m, i) => (
                <motion.div
                  key={i}
                ...
                >
                  <span className="mt-1 h-2.5 w-2.5 shrink-0 rounded-full" style={{ background: m.p }} />
