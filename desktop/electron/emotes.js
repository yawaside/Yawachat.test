// Смайлы для OBS-виджета. Загружаются в main-процессе один раз
// (7TV + BTTV global) и подмешиваются в каждое сообщение перед broadcast.
// Нативные Twitch-эмодзи приходят из IRC-тега emotes.
...
function getJson(url) {
  return new Promise((resolve) => {
    try {
      https
        .get(url, { headers: { accept: "application/json", "user-agent": "YawaChatHub/3.1.2" } }, (res) => {
          let data = "";
...
/** Разбор текста + нативные Twitch emotes → parts[] для виджета. */
