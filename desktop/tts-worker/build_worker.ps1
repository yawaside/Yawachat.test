...
# Исправленная версия: embedded Python из python.org НЕ содержит pip/ensurepip.
# Поэтому мы явно скачиваем get-pip.py и устанавливаем pip.
